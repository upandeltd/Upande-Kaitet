	...
	try:
		...
		for item in pack_list_doc.pack_list_item:
			if (
				...
				and item.bunch_uom == uom
				and item.box_id == box_id
				and item.custom_opl_id == order_id
			):
				item.bunch_qty += 1
